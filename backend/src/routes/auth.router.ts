...
import { checkAuth, deleteOAuthCookie, forgotPassword, login, logout, redirectHandler, resetPassword, sendOAuthCookie, sendOtp, sendPrivateKeyRecoveryEmail, signup, updateFcmToken, updateUserKeys, verifyOtp, verifyPassword, verifyPrivateKeyToken } from "../controllers/auth.controller.js";
...
.post("/send-auth-cookie",validate(setAuthCookieSchema),sendOAuthCookie)
...
.get("/logout",logout)
.get("/delete-oauth-cookie",verifyToken,deleteOAuthCookie)
