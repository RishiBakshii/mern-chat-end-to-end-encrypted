...
export const MessageItem = memo(({message,myMessage=false}:PropTypes) => {
  return (
    <div className={`flex gap-x-2 ${myMessage?"self-end":""}`}>
        ...
        <img className="aspect-square object-cover w-20 self-end rounded-lg" 
        ...
        <div className={`${myMessage?"bg-violet-500 text-white":"bg-gray-200"} w-96 rounded-lg px-4 py-2 flex flex-col gap-y-1`}>
            ...
            {
            !myMessage && <p className="text-violet-500 font-medium">{message.sender.username}</p>
            }
            ...
            <div className="flex justify-between">
                ...
                <p className={`text-sm ${myMessage?"text-white":"text-gray-500"}`}>
